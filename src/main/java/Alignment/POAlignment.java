...
//    private List<Integer> nodeIndexes;
     ...
     */
    public POAlignment(String seq1, String seq2, int openGapPenalty, int extendGapPenalty, SubstitutionMatrix subMatrix, boolean MEA) {
     ...
     * @param MEA Boolean representing whether we are performing Maximum Expected Accuracy alignment
     */
    public POAlignment(HashProfile profile1, HashProfile profile2, int openGapPenalty, int extendGapPenalty, SubstitutionMatrix subMatrix, boolean MEA) {
...
//        this.updatedProfile = this.alignProfileToProfile();
    ...
    public POAlignment(String filepath) {
        graph = new POGraph();
//        this.seq1 = profile1;
//        this.profile2 = profile2;
//        this.openGapPenalty = openGapPenalty;
...
//        this.MEA = MEA;
        ...
        try {
            ...
            for (int seqId = 1; seqId < seqs.size(); seqId++) {
                ...
                List<Integer> alignment = alignProfileToProfile(seqs.get(seqId).toString());
...
//    }
     ...
     */
    public void initialiseDynamicProgrammingData(int l1, int l2) {
    ...
    public List<Integer> backtrack(double[][] scores, int[][] jBackIndexes, int[][] iBackIndexes) {
...
//        return new HashProfile(profile1, profile2);
        ...
        for (int ind = 0; ind < profile1Indexes.size(); ind++)
            if (profile1Indexes.get(ind) != null)
...
//     */
    public List<Integer> alignProfileToProfile(String sequence) {
        ...
        initialiseDynamicProgrammingData(l1, l2);
