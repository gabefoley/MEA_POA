...
public class ProfilePairHMM {
    ...
    private HashProfile updatedProfile;
        ...
        public ProfilePairHMM(String seq1, String seq2, double tau, double epsilon, double delta) {

            HashProfile profile1 = new HashProfile(seq1);
            HashProfile profile2 = new HashProfile(seq2);

            ProfilePairHMM profileHMM = new ProfilePairHMM(profile1, profile2, tau, epsilon, delta);
        }
